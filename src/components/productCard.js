  ...
  render() {
    return (
      <Card style={{width: 350, minHeight: 213, marginBottom: 20}}>
        ...
        <p className="no-decoration black-color hmargin-20">Risk 15% on Capital for 6m</p>
        <Row>
          <Col xs="6">
            <p className="no-decoration black-color margin-0 hmargin-20">NSE</p>
            <p className="no-decoration black-color margin-0" style={{marginLeft: 20}}>+0.51% Profit</p>
            <p className="no-decoration black-color margin-0 font-weight-600" style={{marginLeft: 20}}>Buy</p>
            <p className="no-decoration black-color margin-0" style={{marginLeft: 20}}>01-05-19 | 12:00:00</p>
            <p className="no-decoration black-color margin-0" style={{marginLeft: 20}}>126.65</p>
          </Col>
          <Col xs="6" className="no-decoration black-color text-right">
            ...
            <p className="no-decoration black-color margin-0" style={{marginRight: 20}}>+3.2% p/m</p>
            <p className="no-decoration black-color margin-0 font-weight-600" style={{marginRight: 20}}>Sell</p>
            <p className="no-decoration black-color margin-0" style={{marginRight: 20}}>31-12-19 | 11:59:59</p>
            <p className="no-decoration black-color margin-0" style={{marginRight: 20}}>726.45</p>
          </Col>
        </Row>
        </Link>
        <Row>
